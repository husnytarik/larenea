...
**Larenea Archaeology News** is a web-based digital newspaper platform
focused on archaeological news and events. It allows content management,
publication, and location-based event visualization.

The platform is fully developed and currently live.\
The frontend is built with **HTML, CSS, and Vanilla JavaScript**, while
**Firebase** is used as the backend infrastructure.\
**Leaflet.js** is used for interactive map functionality.

### 🚀 Project Purpose

The project provides a structured and sustainable digital publishing
system for archaeological content, including:
...
It enables centralized content management while offering users a
searchable, filterable, and location-aware experience.
...
-   Enter date and event details\
-   Add latitude and longitude coordinates\
-   Verify event location via Leaflet map integration\
...
- Filter by category\
- Open each article on a dedicated detail page\
- Explore events directly on an interactive map

### 📍 Location-Based Event System

-   Events are displayed as markers on a Leaflet interactive map\
-   The user's location can be retrieved (with permission)\
-   Nearby events are automatically calculated\
-   Close events are highlighted separately\
-   Dynamic distance-based sorting can be applied
